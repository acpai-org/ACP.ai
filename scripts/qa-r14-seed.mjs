...
// can all be exercised in a real browser. Run with node (bun NAPI crash with
// better-sqlite3 — known). Rows carry the QA marker "R14QA" so the cleanup
// pass can delete exactly what this script inserted.
