---
url: "https://docs.attestcoin.org/attestcoin-protocol/architecture"
title: "Architecture | Attestcoin"
---

For the complete documentation index, see [llms.txt](https://docs.attestcoin.org/llms.txt). This page is also available as [Markdown](https://docs.attestcoin.org/attestcoin-protocol/architecture.md).
...
## **Attestcoin Protocol Key Terms**[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#usc-key-terms)
...
## Architecture[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#architecture)

The Attestcoin Protocol relies primarily on the following actors:

### Attestors[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#attestors)
...
> For more information on attestors, check out the [Step 1: Attestation](https://docs.attestcoin.org/attestcoin-protocol/attestcoin-readability/step-1-attestation) section of the docs.

### Validators[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#validators)
...
### Block Prover Precompile[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#native-query-verifier-precompile)
...
### Message Relayers[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#message-relayers)
...
## Outcome for Builders[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#interoperability)
...
> For more information on how to set up your dApp's logic to leverage the Attestcoin protocol, check out the [dApp Builder Infrastructure](https://docs.attestcoin.org/attestcoin-protocol/dapp-builder-infrastructure) section of the docs.

#### Conclusion[Direct link to heading](https://docs.attestcoin.org/attestcoin-protocol/architecture\#conclusion)
...
[PreviousAttestcoin Protocol](https://docs.attestcoin.org/) [NextAttestcoin Readability](https://docs.attestcoin.org/attestcoin-protocol/attestcoin-readability)
