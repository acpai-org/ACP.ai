...
library EvmV1Decoder {
    ...
    // ---------- Public decoders ----------
    function decodeTransactionType0(bytes memory chunk) internal pure returns (DecodedTransactionType0 memory) { require(chunk.length > 0, "EvmV1Decoder: Empty"); return _decodeType0(chunk); }
    function decodeTransactionType1(bytes memory chunk) internal pure returns (DecodedTransactionType1 memory) { require(chunk.length > 0, "EvmV1Decoder: Empty"); return _decodeType1(chunk); }
    function decodeTransactionType2(bytes memory chunk) internal pure returns (DecodedTransactionType2 memory) { require(chunk.length > 0, "EvmV1Decoder: Empty"); return _decodeType2(chunk); }
    function decodeTransactionType3(bytes memory chunk) internal pure returns (DecodedTransactionType3 memory) { require(chunk.length > 0, "EvmV1Decoder: Empty"); return _decodeType3(chunk); }
    function decodeTransactionType4(bytes memory chunk) internal pure returns (DecodedTransactionType4 memory) { require(chunk.length > 0, "EvmV1Decoder: Empty"); return _decodeType4(chunk); }
     ...
     */
    function decodeCommonTxFields(bytes memory chunk) internal pure returns (CommonTxFields memory) {
     ...
     */
    function decodeTypeSpecificFieldsType0(bytes memory chunk) internal pure returns (LegacyFields memory) {
        require(chunk.length > 0, "EvmV1Decoder: Empty");
     ...
     * @dev Gas-efficient: decodes only chunk 2 instead of all chunks
     */
    function decodeTypeSpecificFieldsType1(bytes memory chunk) internal pure returns (Type1Fields memory) {
        require(chunk.length > 0, "EvmV1Decoder: Empty");
        (uint8 type_, bytes[] memory chunks) = abi.decode(chunk, (uint8, bytes[]));
     ...
     * @dev Gas-efficient: decodes only chunk 2 instead of all chunks
     */
    function decodeTypeSpecificFieldsType2(bytes memory chunk) internal pure returns (Type2Fields memory) {
        require(chunk.length > 0, "EvmV1Decoder: Empty");
        (uint8 type_, bytes[] memory chunks) = abi.decode(chunk, (uint8, bytes[]));
     ...
     */
    function decodeTypeSpecificFieldsType3(bytes memory chunk) internal pure returns (Type3Fields memory) {
        require(chunk.length > 0, "EvmV1Decoder: Empty");
        (uint8 type_, bytes[] memory chunks) = abi.decode(chunk, (uint8, bytes[]));
     ...
     * @dev Gas-efficient: decodes only chunks 2 and 3 instead of all chunks
     */
    function decodeTypeSpecificFieldsType4(bytes memory chunk) internal pure returns (Type4Fields memory) {
        require(chunk.length > 0, "EvmV1Decoder: Empty");
        (uint8 type_, bytes[] memory chunks) = abi.decode(chunk, (uint8, bytes[]));
